...
class OrderKurumsal extends StatefulWidget {
  
  final String price;
  final String name;
  final String packagePrice6Month;
  final String packagePriceYear;

  OrderKurumsal(this.price, this.name, this.packagePrice6Month, this.packagePriceYear);

  @override
  _OrderKurumsalState createState() => _OrderKurumsalState();
}

class _OrderKurumsalState extends State<OrderKurumsal> {
...
//              webURL + json.decode(decoded["result"][i]["productImage"])["1"].toString(),
  ...
  @override
  void initState() {
    priceVal = widget.price;
    priceValNum = int.parse(priceVal) ;
    print(widget.packagePrice6Month + widget.packagePriceYear + "mmmmmmmmmmmm");
    super.initState();
  }
                  ...
                  children: [
                                  ...
                                  TableRow(
                                      children: [
                                        ...
                                        Container(
                                            ...
                                            child: Text("${priceVal}" + " " + (Localizations.of<AppLocalizations>(context, AppLocalizations).getTranslation('tl')),
                                              style: TextStyle(color: Colors.black),
                                            )),
                                      ]
                                  ),
                    ...
                    Container(
                      ...
                      child: DropdownButton<String>(
                        ...
                        elevation: 16,
                        hint: Text((Localizations.of<AppLocalizations>(context, AppLocalizations).getTranslation('monthly'))),
                        style:  TextStyle(color: Colors.black),
                        isExpanded: true,
                        onChanged: (String newValue) {
                          setState(() {
                            dropdownValue = newValue;
                            if(newValue == (Localizations.of<AppLocalizations>(context, AppLocalizations).getTranslation('monthly'))){
                              priceVal = widget.price;
                              priceValNum = int.parse(priceVal) ;
                            }else if(newValue == (Localizations.of<AppLocalizations>(context, AppLocalizations).getTranslation('6month'))){
                              priceVal = widget.packagePrice6Month;
                              priceValNum = int.parse(priceVal) * 6;
                          }else if(newValue == (Localizations.of<AppLocalizations>(context, AppLocalizations).getTranslation('yearly'))){
                              priceVal = widget.packagePriceYear;
                              priceValNum = int.parse(priceVal) * 12;
                            }
                          });
                        },
                        items: <String>[
                          (Localizations.of<AppLocalizations>(context, AppLocalizations).getTranslation('monthly')),
                          (Localizations.of<AppLocalizations>(context, AppLocalizations).getTranslation('6month')),
                          (Localizations.of<AppLocalizations>(context, AppLocalizations).getTranslation('yearly')),
                        ]
                                ...
                                Container(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        "${priceVal}" + " " + (Localizations.of<AppLocalizations>(context, AppLocalizations).getTranslation('tl')),
                                        style: TextStyle(color: Colors.black, fontSize: 12),
                                      ),
                                    ],
                                  ),
                                      ...
                                      Text(
                                        priceVal == widget.price ?
                                         "${widget.price}" + " " + (Localizations.of<AppLocalizations>(context, AppLocalizations).getTranslation('tl')) :
                                           priceVal == widget.packagePrice6Month ? "${priceValNum}" + " " + (Localizations.of<AppLocalizations>(context, AppLocalizations).getTranslation('tl')) :
                                          "${priceValNum}" + " " + (Localizations.of<AppLocalizations>(context, AppLocalizations).getTranslation('tl')),
                                        style: TextStyle(fontWeight: FontWeight.bold, color: Colors.white),
                                      ),
                                    ],
                                  ),
                    ...
                    Container(
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: (){
                          Navigator.push(
                              context,
                              new MaterialPageRoute(builder: (context) => new Kurumsal(priceVal, widget.name, priceValNum))
                          );
                        },
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
